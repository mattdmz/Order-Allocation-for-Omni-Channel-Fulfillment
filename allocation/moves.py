...
from numpy import argsort, array, Infinity
...
class Moves:
    ...
    def evaluate(self) -> Union[array, array, array]:
        ...
        # flatten 2D array
        flat_fitness = self.fitness[self.fitness != -Infinity].flatten() #self.fitness.flatten() #
        flat_move_indexes = self.move_indexes[self.move_indexes != None].flatten() #self.move_indexes.flatten() #
