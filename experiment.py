...
def main() -> None:
    ...
    allocation_regions = [1005] #[1001, 1002, 1003, 1004, 1005, 1006, 1007, 1008]
    ...
    allocation_methods = [Tabu_Search] #[Allocation_Of_Nearest_Order, Chepest_Direct_Delivery, Cheapest_Delivery, Dynamic_1, \
                                #Longest_Stock_Duration, Modified_Dynamic_1, Nearest_Already_Allocated_Nodes, Nearest_Nodes, Operational_Costs]
