...
def main() -> None:
    ...
    allocation_methods = [Cheapest_Delivery] #[Chepest_Direct_Delivery, Cheapest_Delivery, Dynamic_1, Longest_Stock_Duration, Modified_Dynamic_1, 
                          #Nearest_Already_Allocated_Nodes, Nearest_Nodes, Operational_Costs, Allocation_Of_Nearest_Order]
